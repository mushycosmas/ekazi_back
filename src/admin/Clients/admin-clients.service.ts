...
export class AdminClientsService {
    ...
    async totalRecruiters(
        ...
        try {
            ...
            // RECRUITER FILTER
            // ========================================================
            // LOWER() so 'recruiter', 'Recruiter', 'RECRUITER' all match.
            // Rows with client_type = NULL are excluded — they are
            // legacy rows you've already migrated to 'employer'.
            // ========================================================
            query.andWhere(
                'LOWER(client.client_type) = :recruiterType',
            ...
            return {
                ...
                message:
                    'Successfully retrieved recruiter profiles',
            ...
            throw new InternalServerErrorException({
                success: false,
                message: 'Failed to fetch recruiter profiles',
                error: error.message,
            });
        }
    }
