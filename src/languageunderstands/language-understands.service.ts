...
export class LanguageUnderstandsService {
  ...
  constructor(
    ...
    private readonly repository:
      Repository<LanguageUnderstands>,
  ...
  async create(
    ...
    return {
      ...
      message:
        'Language understand created successfully.',
  ...
  // INTERNAL FIND ENTITY

  private async findLanguage(
    id: number,
  ): Promise<LanguageUnderstands> {
  ...
  async findAll() {
    ...
    return {
      ...
      message:
        'Language understands fetched successfully.',
  ...
  async findOne(
    ...
    return {
      ...
      message:
        'Language understand fetched successfully.',
  ...
  async update(
    ...
    return {
      ...
      message:
        'Language understand updated successfully.',
  ...
  async remove(
    ...
    return {
      ...
      message:
        'Language understand deleted successfully.',
