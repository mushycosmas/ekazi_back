...
@Injectable()
export class BackgroundCheckStage {
                ...
                const applicant =
                    await this.applicantsRepository.findOne({
                        ...
                        relations: [
                         ...
                         if (applicant) {
                    await this.sendBackgroundCheckEmail({
  ...
  private async sendBackgroundCheckEmail(data: any) {
         ...
         const templateData = {
             ...
             subject:
                 `Background Check: ${positionName} Application Update`,
